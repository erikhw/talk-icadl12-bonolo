...
<<eval-ux-ui, fig=TRUE, echo=FALSE, height=3, width=5.5>>=
ps.options(pointsize=10,family="serif")
bonoloui <- read.table("bonoloui.dat", header=T, sep="\t")
par(xpd=T, mar=par()$mar+c(0,0,0.5,7))
barplot(as.matrix(bonoloui), beside=TRUE, family="serif", xlab="Average UX ratings", ylab="Survey Participants", ylim=c(0,5), col=rainbow(7), cex.axis=0.7, las=1, space=c(0, 4), names.arg=c("Search&\nBrowse", "Navigability", "Similarity", "General"), cex=0.7)
op <- par(family = "serif")
legend(50,4.5, c("Intuitive", "Simple", "Satisfied", "Expected", "Response", "Effective", "Beneficial"), cex=0.7, fill=rainbow(7));
box("inner", "solid")
@  
\end{center}
...
\begin{center}
  %\includegraphics[width=.95\textwidth]{figure.png}
<<eval-ux-ci, fig=TRUE, echo=FALSE, height=3, width=5.5>>=
bonoloci <- read.table("bonoloci.dat", header=T, sep="\t")
par(xpd=T, mar=par()$mar+c(0,0,0.5,7))
#barplot(as.matrix(bonoloci), ylim=c(0,15), col=heat.colors(5), cex.axis=0.7, cex=0.7, las=1, space=0.1, names.arg=c("Interest/\nEnjoyment", "Perceived\nCompetence", "Value/\nUsefulness"))
barplot(as.matrix(bonoloci), family="serif", xlab="Average UX ratings", ylab="Survey Participants", ylim=c(0,25), col=rainbow(5), cex.axis=0.7, las=1, names.arg=c("Interest/\nEnjoyment", "Perceived\nCompetence", "Value/\nUsefulness"), cex=0.7)
#legend(18,10, c("Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"), cex=0.7, fill=heat.colors(5));
op <- par(family = "serif")
legend(4,22, c("Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"), cex=0.6, fill=rainbow(5));
box("inner", "solid")
@  
\end{center}
...
\begin{center}
  %\includegraphics[width=.95\textwidth]{figure.png}
<<eval-perf, fig=TRUE, echo=FALSE, height=3, width=5.5>>=
ps.options(pointsize=10,family="serif")
bonoloperf <- read.table("bonoloperf.dat", header=T, sep="\t")
par(xpd=T, mar=par()$mar+c(0,0.5,-1,5), cex=0.7)
plot_colors <- c("blue", "red")
plot(bonoloperf$Initial, type="o", col=plot_colors[1], ylim=c(0,10), axes=FALSE, ann=FALSE)
op <- par(family = "serif")
axis(1, at=1:6, lab=c("1,024", "2,048", "4,096", "8,192", "16,384", "32,768"))
...
legend(1, 10, c("Initial Load", "Page Load"), cex=0.7, col=plot_colors, pch=21:22, lty=1:2)
box("figure", "solid")
@  
\end{center}
\end{frame}
...
\begin{frame}
\begin{center}
<<eval-ux-ci, fig=TRUE, echo=FALSE, height=2.5, width=4>>=
bonoloci <- read.table("bonoloci.dat", header=T, sep="\t")
par(xpd=T, mar=par()$mar+c(0,0.5,0,5), cex=0.7)
barplot(as.matrix(bonoloci), family="serif", xlab="Average UX ratings", ylab="Survey Participants", ylim=c(0,25), col=rainbow(5), cex.axis=0.7, las=1, names.arg=c("Interest/\nEnjoyment", "Perceived\nCompetence", "Value/\nUsefulness"), cex=0.7)
op <- par(family = "serif")
legend(4,22, c("Strongly Agree", "Agree", "Neutral", "Disagree", "Strongly Disagree"), cex=0.6, fill=rainbow(5));
box("inner", "solid")
