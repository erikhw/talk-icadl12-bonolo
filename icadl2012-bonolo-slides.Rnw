...
\centering
%\framebox[\textwidth]{%
\input{images/latexdraw/icadl2012-bonolo-repository-structure-new.tex}
%}
\end{figure}
\end{frame}
...
\centering
%\framebox[\textwidth]{%
\includegraphics[width=\linewidth, height=\textwidth, keepaspectratio]{images/icadl2012-bonolo-ui-item.eps}
%}
%\caption{End User Interface}
\end{figure}
\end{frame}
...
\centering
%\framebox[\textwidth]{%
\includegraphics[width=\linewidth, height=\textwidth, keepaspectratio]{images/icadl2012-bonolo-ci-item.eps}
%}
