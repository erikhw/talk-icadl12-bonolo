...
\centering
\framebox[\textwidth]{%
\includegraphics{images/icadl2012-bonolo-martinwest.eps}
}
...
\centering
\framebox[\textwidth]{%
\includegraphics{images/icadl2012-bonolo-lloydbleek-elephant.eps}
}
\end{figure}
\end{frame}
...
\centering
\framebox[\textwidth]{%
\input{images/latexdraw/icadl2012-bonolo-design.tex}
}
\end{figure}
\end{frame}
...
\centering
\framebox[\textwidth]{%
\input{images/latexdraw/icadl2012-bonolo-repository.tex}
}
\end{figure}
\begin{itemize}
...
\centering
\framebox[\textwidth]{%
\input{images/latexdraw/icadl2012-bonolo-repository-structure.tex}
}
\end{figure}
\end{frame}
...
\centering
\framebox[\textwidth]{%
\input{images/latexdraw/icadl2012-bonolo-clients-public.tex}
}
%\caption{End User Interface}
\end{figure}
\begin{itemize}
...
\centering
\framebox[\textwidth]{%
\includegraphics{images/icadl2012-bonolo-ui-item.eps}
}
%\caption{End User Interface}
\end{figure}
\end{frame}
...
\centering
\framebox[\textwidth]{%
\input{images/latexdraw/icadl2012-bonolo-clients-curator.tex}
}
%\caption{End User Interface}
\end{figure}
\begin{itemize}
...
\centering
\framebox[\textwidth]{%
\includegraphics{images/icadl2012-bonolo-ci-item.eps}
}
...
\centering
\input{plots/evaluation-ux-ui.tex}
\end{frame}
...
\centering
\input{plots/evaluation-ux-ci.tex}
\end{frame}
...
\centering
\input{plots/evaluation-perf.tex}
\end{frame}
